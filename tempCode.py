## Image Encryption, watermark, etc code starts .
        ...
        def waterMarkImageClicked(self, watermark=' This Image is Encrypted! '):
            ...
            channel = 0
            if watermark == False:
                watermark = ' This Image is Encrypted '  # rarest of the rare case, that they ever come together in a random Image.
        ...
        def encryptImageHelper(self, data):
            ...
            self.lastFilter = 'Image Encryption'
            self.initializeSlider()
            data += '\n\n!@#$%^&*'  # this is faster than normal and there is a very low chance of getting this in any expression continuously!
            print('Encrypting:')
            rows = 0
            cols = 0
            channel = 0
