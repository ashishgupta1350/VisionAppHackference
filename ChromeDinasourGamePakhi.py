...
def action():
    ...
    while True:
        ...
        cv2.rectangle(frame,(80,80),(300,300),(0,255,255),2)
        action_frame = frame[80:300, 80:300]
        ...
        try:
            ...
            cv2.drawContours(spot,largest_contour,c_index, (0,0,255),2)
    ...
    #         elif defect_count<=0:
    #             cv2.putText(frame,"zero", (80,80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)

    #         elif defect_count==1:
    #             cv2.putText(frame,"two", (80,80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)
    #         elif defect_count==2:
    #             cv2.putText(frame,"three", (80,80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)
    #         elif defect_count==3:
    #             cv2.putText(frame,"four", (80,80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)
